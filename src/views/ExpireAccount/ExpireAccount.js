...
import { paypalPlanId } from "config";
        ...
        <Grid item lg={6} xs={12}>
          <div className={classes.content}>
            <Typography variant="h1">
              Account Expire: your account has been expire
            </Typography>
            <Typography variant="subtitle2">
              You have to upgrade your plan or subscribe using PayPal otherwise
              you will not able to use AreoLand anymore. If you have any query
